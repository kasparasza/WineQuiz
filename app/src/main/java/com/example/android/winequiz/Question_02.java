...
public class Question_02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        optionAButton.setImageResource(R.drawable.question_02_answer_pict_01);
        optionBButton.setImageResource(R.drawable.question_02_answer_pict_02);
        optionCButton.setImageResource(R.drawable.question_02_answer_pict_03);
        optionDButton.setImageResource(R.drawable.question_02_answer_pict_04);
        questionNumber.setText(R.string.question_02);
        questionText.setText(R.string.question_02_text);
    }
    ...
    public void changeQuestion(View view) {
        ...
        if (!answerA && !answerB && !answerC && !answerD) {
            ...
            Intent goToNextQuestion = new Intent(this, Question_03.class);
    ...
    public void selectAnswerOption(View view) {
        ...
        if (optionAButton.isPressed()) {
            optionAButton.setImageResource(R.drawable.question_02_answer_pict_01_pressed);
            optionBButton.setImageResource(R.drawable.question_02_answer_pict_02);
            optionCButton.setImageResource(R.drawable.question_02_answer_pict_03);
            optionDButton.setImageResource(R.drawable.question_02_answer_pict_04);
            ...
            optionAButton.setImageResource(R.drawable.question_02_answer_pict_01);
            optionBButton.setImageResource(R.drawable.question_02_answer_pict_02_pressed);
            optionCButton.setImageResource(R.drawable.question_02_answer_pict_03);
            optionDButton.setImageResource(R.drawable.question_02_answer_pict_04);
            answerB = true;
            ...
            optionAButton.setImageResource(R.drawable.question_02_answer_pict_01);
            optionBButton.setImageResource(R.drawable.question_02_answer_pict_02);
            optionCButton.setImageResource(R.drawable.question_02_answer_pict_03_pressed);
            optionDButton.setImageResource(R.drawable.question_02_answer_pict_04);
            answerC = true;
            ...
            optionBButton.setImageResource(R.drawable.question_02_answer_pict_02);
            optionCButton.setImageResource(R.drawable.question_02_answer_pict_03);
            optionDButton.setImageResource(R.drawable.question_02_answer_pict_04_pressed);
            answerD = true;
